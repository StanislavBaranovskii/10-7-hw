# Домашнее задание к занятию "`10.7. Отказоустойчивость в облаке`" - `Барановский Станислав`
...
```
```
[**Terraform Playbook**](https://github.com/StanislavBaranovskii/10-7-hw/blob/main/data/)


![Скриншот статуса балансировщика и целевой группы](https://github.com/StanislavBaranovskii/10-7-hw/blob/main/img/10-7-1-1.png "Скриншот sстатуса балансировщика и целевой группы")

![Скриншот страницы IP-адреса балансировщика](https://github.com/StanislavBaranovskii/10-7-hw/blob/main/img/10-7-1-2.png "Скриншот страницы IP-адреса балансировщика")
...
![Скриншот статуса балансировщика и целевой группы](https://github.com/StanislavBaranovskii/10-7-hw/blob/main/img/10-7-2-1.png "Скриншот sстатуса балансировщика и целевой группы")

![Скриншот страницы IP-адреса балансировщика](https://github.com/StanislavBaranovskii/10-7-hw/blob/main/img/10-7-2-2.png "Скриншот страницы IP-адреса балансировщика")
